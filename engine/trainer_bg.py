...
from utils.dataset_bg import roadDataset, roadDatasetInfer
        ...
        for epoch in range(self.num_epochs):
            ...
            for i, data in enumerate(data_loaders):
                ...
                if i % self.print_interval == 0 or outputs.size()[0] < self.train_batch_size:
                    ...
                    self.logger.info(' Epoch:{}({}/{}) loss:{:.3f} learning rate:{}'.format(epoch, count, dset_sizes // self.train_batch_size,loss.item(), optimizer.param_groups[-1]['lr']))
